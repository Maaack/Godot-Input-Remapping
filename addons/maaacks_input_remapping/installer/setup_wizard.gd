...
func _refresh_plugin_details() -> void:
	for enabled_plugin in ProjectSettings.get_setting("editor_plugins/enabled"):
		if enabled_plugin.contains(MaaacksInputRemapping.get_settings_path()):
...
func _open_check_plugin_version() -> void:
	if PluginUpdater.instance == null:
		...
		return
	var check_version_instance := PluginUpdater.instance.get_check_plugin_version(MaaacksInputRemappingPlugin.instance.get_plugin_path(), MaaacksInputRemappingPlugin.PLUGIN_REPO_URL)
...
func _on_update_button_pressed():
	tree_exited.connect(func(): PluginUpdater.instance.open_update_plugin(MaaacksInputRemappingPlugin.instance.get_plugin_path(), MaaacksInputRemappingPlugin.PLUGIN_REPO_URL))
	queue_free()
